...
const Menu = () => {
  ...
  return (
    <div className="font-sans">
      {/* Breadcrumb Section */}
      <section className="breadcrumb_bg bg-cover bg-center py-20" style={{ backgroundImage: "url('img/breadcrumb_bg.jpg')" }}>
        <div className="container mx-auto px-4">
          <div className="flex justify-center">
            <div className="text-center">
              <h2 className="text-4xl font-bold text-white">Food Menu</h2>
            </div>
          </div>
        </div>
      </section>
