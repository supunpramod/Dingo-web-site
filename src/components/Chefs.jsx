  ...
  return (
    <div className="font-sans">
        ...
        <div className="container mx-auto px-4 relative z-10">
          <div className="flex justify-center">
            <div className="text-center">
              <h2 className="text-4xl font-bold text-white">Experienced Chefs</h2>
            </div>
          </div>
        </div>
      </section>
      ...
      <section 
        ...
        style={{ backgroundImage: "url('img/intro_video_bg.jpg')" }}
      >
        <div className="absolute inset-0 bg-black bg-opacity-50"></div>
        <div className="container mx-auto px-4 relative z-10">
          <div className="text-center text-white">
            ...
            <div className="flex justify-center">
              <a 
                ...
                className="bg-white text-orange-500 w-16 h-16 rounded-full flex items-center justify-center text-2xl hover:bg-orange-500 hover:text-white transition duration-300"
              >
